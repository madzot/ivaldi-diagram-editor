...
class SpiderTests(TestMainDiagram):
    ...
    def test__init__values(self):
        spider = Spider(None, 0, "spider", (100, 150), self.custom_canvas)
    ...
    def test__on_control_press__selects_wires_between(self):
        spider1 = Spider(None, 0, "spider", (100, 150), self.custom_canvas)
        spider2 = Spider(None, 0, "spider", (200, 150), self.custom_canvas)
    ...
    def test__is_illegal_move__can_be_next_to_connected_connection(self):
        spider = Spider(None, 0, "spider", (100, 100), self.custom_canvas)
        spider2 = Spider(None, 1, "spider", (150, 100), self.custom_canvas)
    ...
    def test__is_illegal_move__cant_go_from_right_to_left_with_connected_connection(self):
        spider = Spider(None, 0, "spider", (150, 150), self.custom_canvas)
